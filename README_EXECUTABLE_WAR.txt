...
>java -Ddatasource.dialect=MYSQL -Ddatasource.url=jdbc:mysql://localhost:3306/lavagna -Ddatasource.username=root -Ddatasource.password=secretpass -Dspring.profile.active=dev -jar lavagna-jetty-console.war
