...
It's distributed in 2 forms:
 ...
 - self contained war with embedded jetty web server1
...
```
https://registry.hub.docker.com/r/digitalfondue/lavagna #!!! Here
```
...
```
mvn jetty:run -Pdev-mysql #!!! Here
```
```
mvn jetty:run -Pdev-pgsql # ! here
```
